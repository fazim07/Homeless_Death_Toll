...
author: "Faiza Imam"
thanks: "Code and data from this analysis are availble at: https://github.com/fazim07/Homeless_Death_Toll "
date: today
date-format: long
abstract: "Toronto’s homeless crisis has been a persistent issue for years which prommpted Toronto Public Health to bgein collecting data on the death tolls among this population back in 2017. Using the data acquired from OpenData Toronto, this paper investigated the relationship between the time of year and its impact on the death toll of the homeless population and the findings suggest that there is no correlation."
format: pdf
toc: true
...
@fig-3, displays the monthly death tolls grouped by year. The months of January and May once again have high recorded death tolls throughout the years. However, in 2021, the months of August to November have higher death tolls compared to the previous year's records. 
```{r}
#| label: fig-3
#| fig-cap: Monthly Death Tolls on a Yearly basis
#| echo: false
#| 
...
data_clean_no_NA %>%
  ...
  #Code Reference:https://stackoverflow.com/questions/1330989/rotating-and-spacing-axis-labels-in-ggplot2
  #Code ref2:https://stackoverflow.com/questions/42995155/r-bar-plot-with-3-variables
...
The data set used for analysis may have potential errors which may have affected the overall results. One of the errors may have been from my conclusion to omit “NA” variables. In the month's column of the set, there were a few “NA” entries and I decided to omit them during the cleanup process to avoid any outliers. The data set recorded began in 2017, effects of COVID-19 may be a vital player in the data collected as the pandemic may have limited the degree of data collection as we see @fig-yearly-bar, where this is increased in death tolls in 2021 in comparision to previous years.

Moreover in @fig-3, there is an increase in recorded death tolls in 2021 which was during the peak of the pandemic. This may have affected the data as there had been an increase in recorded death tolls spanning from August to November 2021. This external factor may have masked any potential seasonal or weather-related trends. However, is it important to highlight that the death tolls reported for this specific data set may not reflect the true numbers as there may be more homeless death tolls that have not been accounted for. This requires improved data collection methods and a holistic plan to navigate existing and potential factors regarding death tolls among the homeless populations. 
...
# Conclusion
This paper investigated the connection between the time of year (months) and the effects on the death toll of homeless people from the recorded death tolls from the years 2017-2023. My results reveal that there is no correlation between the time of year and its impact on death tolls among the homeless population. Variables such as cause of death, situational implications, shelter capacity and records, location within the GTA, and gender implications should be analyzed and studied to further understand the trends of homeless death tolls in Toronto. The data collection of records from 2024, projected to be released near the end of the fourth quarter (@Odata), may reveal further information and implications regarding the death toll trends among the homeless population. As mentioned previously in the paper, homelessness is not a choice one makes but rather falls victim due to complex interconnected factors, often beyond the individual's control. Toronto’s homelessness crisis is an ongoing issue that requires a multifaceted and comprehensive approach to find an impactful and sustainable solution data analyzed such as this paper, can aid in finding patterns to find a solution.
